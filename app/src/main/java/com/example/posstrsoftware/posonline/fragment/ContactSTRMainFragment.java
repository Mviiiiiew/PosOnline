...
public class ContactSTRMainFragment extends Fragment {
    ...
    public static ContactSTRMainFragment newInstance() {
        ContactSTRMainFragment fragment = new ContactSTRMainFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_main_con, container, false);
